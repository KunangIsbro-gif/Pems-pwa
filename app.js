      ...
      <section class="admin-section" data-admin-panel="project-setup">
        <div class="card">
          ...
          <div class="plan-files-box" style="margin-top:18px">
            ...
            <div class="status-box neutral" style="margin-top:12px"><b>R11N-P2 HF1:</b> file sumber + versioning aktif. Auto Review dibaca sistem, Admin menyiapkan/mapping, PM/LEADER memberi keputusan Publish.</div>
...
function updateAdminPlanReviewPanelPEMS_(p) {
  ...
  const hasFiles=!!p.boqPlanFileId&&!!p.kmlPlanFileId; if(run)run.disabled=!hasFiles;if(view)view.disabled=!p.planReviewAt;if(mapBtn)mapBtn.disabled=!p.boqPlanFileId;if(complete)complete.disabled=!p.planReviewAt||s==='BLOCKED'||s==='NOT_REVIEWED';
