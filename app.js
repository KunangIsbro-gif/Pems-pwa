      ...
      <section class="admin-section hidden" data-admin-panel="proactive-import">
        <div class="card">
          <div class="section-head">
            ...
            <span class="badge info">R11N-P3</span>
          </div>
      ...
      <section class="admin-section" data-admin-panel="project-setup">
        <div class="card">
          ...
          <div class="plan-files-box" style="margin-top:18px">
            ...
            <div class="status-box neutral" style="margin-top:12px"><b>R11N-P3:</b> file sumber + versioning aktif. Auto Review dibaca sistem, Admin menyiapkan/mapping, PM/LEADER memberi keputusan Publish.</div>
